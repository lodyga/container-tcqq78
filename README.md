...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tcqq78.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tcqq78.containers.anotherwebservice.com/
...
```
git clone git@github.com:lodyga/container-tcqq78.git
cd container-tcqq78
```
...
```
docker attach container-tcqq78
```
